...
function setup() {
   ...
   coinscollect = 0;
  //check my discord https://discord.gg/9Qrq7Uz78R
...
function draw() {
  ...
  if (player.isTouching(stonegroup) ||player.isTouching(snakegroup)||player.isTouching(birdsgroup))      {
       player.velocity = 0;
